...
for i in range(0, len(data), 100):
    ...
    result3 = pd.concat([result3, subset])
    # result3.to_csv(f'/workspace/llm/sentiment/code/result3_{i+100}.csv', encoding='utf-8-sig')
    
    
result3.reset_index(drop=True, inplace=True)
result3.to_csv('/workspace/llm/sentiment/code/result3.csv', encoding='utf-8-sig')